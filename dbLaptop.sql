...
CREATE TRIGGER UTG_UpdateRateSP ON DanhGia
 ...
 BEGIN
    UPDATE SanPham
     SET DiemRate = DiemRate + (SELECT Diem
    FROM INSERTED
    WHERE MaSanPham = SanPham.MaSanPham),
...
--Sản phẩm
INSERT INTO SanPham
    (TenSanPham, MaDanhMuc, SeoTitle, MaThuongHieu, GiaBan, GiaGiam, BaoHanh, MaLoaiCPU, CPUInfo, RAM, MaLoaiGPU, GPUInfo, SizeManHinh, ManHinh, Pin, LuuTru, KhoiLuong, Hinh, NgayTao)
...
INSERT INTO SanPhamNhapKho
    (MaSanPham, SoLuong, GiaNhap, NgayTao)
...
INSERT INTO NguoiDung
    (Ten, Username, Password, SDT, Email, DiaChi, MaQuyen, NgayTao)
VALUES(N'Trần Văn Chuyên', N'admin', N'202cb962ac59075b964b07152d234b70', '0123456789', NULL, N'958 Phố Hằng, Xã Uyên Trưởng, Quận 53 Hồ Chí Minh', 1, N'2021-11-05 05:35:21'),
    ...
    (N'Nguyễn Văn Ướt', N'khach2', N'202cb962ac59075b964b07152d234b70', '0123456789', NULL, N'258 Ba Trieu', 4, N'2021-11-05'),
    (N'Lăng Ra Ngủ', N'khach3', N'202cb962ac59075b964b07152d234b70', '0123456789', NULL, N'40B Street 3/2, Ninh Kieu District', 4, N'2021-11-05')
GO
--Voucher
INSERT INTO PhieuQuaTang
    (TenPhieuQuaTang, MaGiamGia, LoaiPhamVi, GiaTri, GiaTriDonHangToiThieu, SoLuong, NgayTao, NgayKichHoat, NgayKetThuc, Status)
VALUES
